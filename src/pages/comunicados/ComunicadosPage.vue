    ...
    >
      ...
      <template #table>
        ...
        >
          ...
          <template #body-cell-audience="props"
          ...
          <template #body-cell-actions="props">
            <q-td :props="props" class="table-actions">
              ...
              <q-btn flat round dense icon="more_horiz" class="table-icon"
                ><q-tooltip>Mas acciones</q-tooltip></q-btn
              >
            </q-td>
          </template>
        </q-table>
...
type MessageRow = {
  ...
  detail: string;
  audience: string;
  status: 'Programado' | 'Publicado' | 'Archivado';
  initials: string;
};
type SortOption = 'recent' | 'oldest' | 'name';
const search = ref('');
const statusFilter = ref<'Todos' | 'Programado' | 'Publicado' | 'Archivado'>('Todos');
...
const rows: MessageRow[] = [
  {
    id: 1,
    message: 'Mantenimiento de piscina',
    detail: 'Condominio Aurora - residentes',
    audience: 'Todos',
    status: 'Publicado',
    initials: 'MP',
  },
  {
    id: 2,
    message: 'Corte de agua programado',
    detail: 'Residencial Pacific - bloque A',
    audience: 'Todos',
    status: 'Programado',
    initials: 'CA',
  },
  {
    id: 3,
    message: 'Reunion de copropietarios',
    detail: 'Torres del Verde - sala comunal',
  ...
  {
    id: 4,
    message: 'Uso de parqueaderos',
    detail: 'Marina Bay - recordatorio',
    audience: 'Residentes',
    status: 'Publicado',
    initials: 'UP',
  },
  {
    id: 5,
    message: 'Cambio de horario',
    detail: 'Condominio Aurora - acceso',
    audience: 'Todos',
    status: 'Programado',
    initials: 'CH',
  },
  {
    id: 6,
    message: 'Fumigacion interna',
    detail: 'Residencial Pacific - torre B',
    audience: 'Residentes',
    status: 'Publicado',
    initials: 'FI',
  },
  {
    id: 7,
    message: 'Normas de uso',
    detail: 'Torres del Verde - areas comunes',
    audience: 'Propietarios',
    status: 'Publicado',
    initials: 'NU',
  },
  {
    id: 8,
    message: 'Inspeccion tecnica',
    detail: 'Marina Bay - ascensores',
  ...
  },
  {
    ...
    detail: 'Condominio Aurora - mensualidad',
    audience: 'Todos',
    status: 'Publicado',
    initials: 'RP',
  },
  {
    id: 10,
    message: 'Cierre temporal de acceso',
    detail: 'Residencial Pacific - garita',
    audience: 'Todos',
    status: 'Archivado',
    initials: 'CT',
  },
  {
    id: 11,
    message: 'Evento comunitario',
    detail: 'Torres del Verde - salon social',
    audience: 'Residentes',
    status: 'Publicado',
    initials: 'EC',
  },
  {
    id: 12,
    message: 'Actualizacion de reglamento',
    detail: 'Marina Bay - documento general',
    audience: 'Propietarios',
    status: 'Programado',
    initials: 'AR',
  },
...
const columns = [
  { name: 'message', label: 'Comunicado', field: 'message', align: 'left' as const },
  { name: 'audience', label: 'Dirigido a', field: 'audience', align: 'left' as const },
...
const sortedRows = computed(() => {
  ...
  if (sortBy.value === 'name') return source.sort((a, b) => a.message.localeCompare(b.message));
...
function statusTone(status: MessageRow['status']) {
  if (status === 'Publicado') return 'positive';
  if (status === 'Programado') return 'warning';
  return 'grey';
}
</script>
<style scoped>
