        ...
        >
          ...
          <template #body-cell-actions="props">
            <q-td :props="props" class="table-actions">
              ...
              >
              <q-btn flat round dense icon="download" class="table-icon"
...
const search = ref('');
const statusFilter = ref<'Todos' | 'Listo' | 'En curso' | 'Pendiente'>('Todos');
...
const rows: ReportRow[] = [
  {
    ...
    detail: 'Condominio Aurora - Enero',
    type: 'PDF',
    status: 'Listo',
    initials: 'RF',
  },
  {
    id: 2,
    report: 'Mora general',
    detail: 'Residencial Pacific - Enero',
    type: 'XLS',
    status: 'En curso',
    initials: 'MG',
  },
  {
    id: 3,
    report: 'Uso de areas',
    detail: 'Torres del Verde - mensual',
    type: 'PDF',
    status: 'Pendiente',
    initials: 'UA',
  },
  {
    id: 4,
    report: 'Ingresos por cobro',
    detail: 'Marina Bay - Enero',
    type: 'XLS',
    status: 'Listo',
    initials: 'IC',
  },
  {
    id: 5,
    report: 'Ocupacion unidades',
    detail: 'Condominio Aurora - Febrero',
    type: 'PDF',
    status: 'En curso',
    initials: 'OU',
  },
  {
    id: 6,
    report: 'Balance operativo',
    detail: 'Residencial Pacific - trimestral',
    type: 'PDF',
    status: 'Listo',
    initials: 'BO',
  },
  {
    id: 7,
    report: 'Visitantes',
    detail: 'Torres del Verde - diario',
    type: 'CSV',
    status: 'Pendiente',
    initials: 'VI',
  },
  ...
  },
  {
    ...
    detail: 'Condominio Aurora - mensual',
    type: 'XLS',
    status: 'Listo',
    initials: 'MA',
  },
  {
    id: 10,
    report: 'Comunicados',
    detail: 'Residencial Pacific - resumen',
    type: 'PDF',
    status: 'Pendiente',
    initials: 'CO',
  },
  {
    id: 11,
    report: 'Seguridad',
    detail: 'Torres del Verde - control',
    type: 'CSV',
    status: 'En curso',
    initials: 'SE',
  },
...
const columns = [
  { name: 'report', label: 'Reporte', field: 'report', align: 'left' as const },
...
const sortedRows = computed(() => {
  ...
  if (sortBy.value === 'name') return source.sort((a, b) => a.report.localeCompare(b.report));
...
function statusTone(status: ReportRow['status']) {
  if (status === 'Listo') return 'positive';
