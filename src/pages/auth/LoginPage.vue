        ...
        <q-img class="auth-hero__image" :src="loginHero" fit="cover" alt="Condominio moderno">
          ...
          <div class="auth-hero__content">
            <div class="auth-hero__brand">
              <div class="auth-hero__brand-mark"><q-icon name="apartment" size="28px" /></div>
            ...
            <div class="auth-feature-list">
              <div v-for="feature in features" :key="feature.title" class="auth-feature">
                <div class="auth-feature__icon"><q-icon :name="feature.icon" size="20px" /></div>
            ...
            <q-card class="auth-hero__callout" flat>
              <q-card-section class="auth-hero__callout-content">
                <div class="auth-hero__callout-icon"><q-icon name="apartment" size="30px" /></div>
      ...
      <section class="auth-panel">
          ...
          <q-btn class="auth-lang" outline no-caps color="grey-7" icon="language" label="Español">
            <q-menu anchor="bottom right" self="top right">
              <q-list style="min-width: 180px">
                <q-item v-close-popup clickable> <q-item-section>Español</q-item-section> </q-item>
                <q-item v-close-popup clickable> <q-item-section>English</q-item-section> </q-item>
              </q-list>
            </q-menu>
          </q-btn>
        </div>
        <div class="auth-panel__card">
          <div class="auth-panel__brand">
            <div class="auth-panel__brand-mark"><q-icon name="apartment" size="32px" /></div>
          ...
          <q-form class="auth-form" @submit.prevent="handleSubmitLogin">
            ...
            <div class="auth-form__security">
              ...
              <div class="auth-form__security-text">
                <q-icon name="shield" size="16px" /> <span>Conexión segura y protegida</span>
              </div>
              <q-separator class="auth-form__security-line" />
            </div>
          </q-form>
