    ...
    <div class="activate-access-page__shell">
      <q-card class="activate-access-card" flat bordered>
        <div class="activate-access-card__brand">
          <div class="activate-access-card__brand-mark"><q-icon name="shield" size="28px" /></div>
        ...
        <q-banner v-else-if="successMessage" class="activate-access-card__success" rounded dense>
          {{ successMessage }}
        </q-banner>
