...
const rows: ReservationRow[] = [
  {
    id: 1,
    space: 'Salon social',
    detail: 'Condominio Aurora - 18 Ene',
    status: 'Confirmada',
    initials: 'SS',
  },
  {
    id: 2,
    space: 'Piscina',
    detail: 'Residencial Pacific - 19 Ene',
    status: 'Pendiente',
    initials: 'PI',
  },
  {
    id: 3,
    space: 'Cancha multiple',
    detail: 'Torres del Verde - 20 Ene',
    status: 'Cancelada',
    initials: 'CM',
  },
  { id: 4, space: 'Area BBQ', detail: 'Marina Bay - 22 Ene', status: 'Confirmada', initials: 'BB' },
  {
    id: 5,
    space: 'Salon social',
    detail: 'Condominio Aurora - 24 Ene',
    status: 'Pendiente',
    initials: 'SS',
  },
  {
    id: 6,
    space: 'Gimnasio',
    detail: 'Residencial Pacific - 25 Ene',
    status: 'Confirmada',
    initials: 'GI',
  },
  {
    id: 7,
    space: 'Cancha multiple',
    detail: 'Torres del Verde - 26 Ene',
    status: 'Confirmada',
    initials: 'CM',
  },
  { id: 8, space: 'Coworking', detail: 'Marina Bay - 27 Ene', status: 'Pendiente', initials: 'CW' },
  {
    id: 9,
    space: 'Piscina',
    detail: 'Condominio Aurora - 28 Ene',
    status: 'Confirmada',
    initials: 'PI',
  },
  {
    id: 10,
    space: 'Area BBQ',
    detail: 'Residencial Pacific - 29 Ene',
    status: 'Cancelada',
    initials: 'BB',
  },
  {
    id: 11,
    space: 'Salon social',
    detail: 'Torres del Verde - 30 Ene',
    status: 'Confirmada',
    initials: 'SS',
  },
...
const filteredRows = computed(() => {
  ...
  return rows.filter((row) => {
    ...
    const matchesQuery =
      !query || row.space.toLowerCase().includes(query) || row.detail.toLowerCase().includes(query);
