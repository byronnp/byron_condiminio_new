...
type VisitorRow = {
  ...
  visitor: string;
  detail: string;
  status: 'Autorizado' | 'En espera' | 'Salida';
  initials: string;
};
...
const rows: VisitorRow[] = [
  {
    id: 1,
    visitor: 'Andres Molina',
    detail: 'Condominio Aurora - unidad 302',
    status: 'Autorizado',
    initials: 'AM',
  },
  {
    id: 2,
    visitor: 'Patricia Ruiz',
  ...
  {
    id: 3,
    visitor: 'Carlos Paredes',
    detail: 'Torres del Verde - unidad 120',
    status: 'Salida',
    initials: 'CP',
  },
  {
    id: 4,
    visitor: 'Lucia Herrera',
    detail: 'Marina Bay - visita familiar',
    status: 'Autorizado',
    initials: 'LH',
  },
  {
    id: 5,
    visitor: 'Javier Ponce',
    detail: 'Condominio Aurora - proveedor',
    status: 'En espera',
    initials: 'JP',
  },
  {
    id: 6,
    visitor: 'Daniela Salazar',
    detail: 'Residencial Pacific - unidad 215',
    status: 'Autorizado',
    initials: 'DS',
  },
  {
    id: 7,
    visitor: 'Miguel Narvaez',
    detail: 'Torres del Verde - evento',
    status: 'Salida',
    initials: 'MN',
  },
  {
    id: 8,
    visitor: 'Elena Cardenas',
    detail: 'Marina Bay - familiar',
    status: 'Autorizado',
    initials: 'EC',
  },
  {
    id: 9,
    visitor: 'Santiago Vera',
    detail: 'Condominio Aurora - tecnico',
    status: 'En espera',
    initials: 'SV',
  },
  {
    id: 10,
    visitor: 'Paola Mendoza',
    detail: 'Residencial Pacific - courier',
    status: 'Autorizado',
    initials: 'PM',
  },
  {
    id: 11,
    visitor: 'Ricardo Mendez',
    detail: 'Torres del Verde - entrega',
    status: 'Salida',
    initials: 'RM',
  },
  {
    id: 12,
    visitor: 'Adriana Solis',
    detail: 'Marina Bay - visita',
    status: 'Autorizado',
    initials: 'AS',
  },
];
...
const filteredRows = computed(() => {
  ...
  return rows.filter((row) => {
    ...
    const matchesQuery =
      !query ||
      row.visitor.toLowerCase().includes(query) ||
...
function statusTone(status: VisitorRow['status']) {
  if (status === 'Autorizado') return 'positive';
