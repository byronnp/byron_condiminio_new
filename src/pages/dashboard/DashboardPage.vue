        ...
        <q-card-section class="hero-card__content">
          <div class="hero-card__left">
            ...
            <div class="hero-card__title">
              {{
                session.isSenior
                  ? 'Administración centralizada multi-condominio'
                  : 'Operación diaria del condominio activo'
              }}
            </div>
          ...
          <div class="hero-card__right">
            <q-chip square class="hero-badge">
              <q-icon name="person" size="16px" class="q-mr-xs" /> {{ roleLabel }}
            </q-chip>
            <q-chip square class="hero-badge hero-badge--solid">
              <q-icon name="pin_drop" size="16px" class="q-mr-xs" /> {{ condoLabel }}
            </q-chip>
            <q-chip square class="hero-badge">
            ...
            <q-card-section class="chart-placeholder">
              <div class="chart-placeholder__legend">
                <div class="chart-key chart-key--income">
                  <span class="chart-key__dot" /> Ingresos
                </div>
                <div class="chart-key chart-key--expense">
                  <span class="chart-key__dot" /> Gastos
                </div>
              </div>
            ...
            <q-card-section class="donut-placeholder">
              <div class="donut-placeholder__ring">
                <div class="donut-placeholder__center">
                  <strong>{{ paymentPercent }}%</strong> <span>Al día</span>
                </div>
              </div>
            ...
            <q-card-section class="panel-card__header">
              <div>
                ...
                <div class="panel-card__subtitle">
                  {{
                    session.isSenior
                      ? 'Últimos movimientos consolidados'
                      : 'Últimos movimientos del condominio'
                  }}
                </div>
              </div>
            ...
            <q-card-section class="panel-card__header">
              <div>
                ...
                <div class="panel-card__subtitle">
                  {{
                    session.isSenior
                      ? 'Alertas para todos los condominios'
                      : 'Alertas del condominio activo'
                  }}
                </div>
              </div>
              <q-btn flat dense no-caps label="Ver todos" class="link-action" />
        ...
        <q-card class="panel-card panel-card--stacked">
          <q-card-section class="panel-card__header">
            <div>
              ...
              <div class="panel-card__subtitle">
                {{
                  session.isSenior
                    ? 'Puedes cambiar el condominio desde el header.'
                    : 'El acceso queda limitado al condominio asignado.'
                }}
              </div>
            </div>
          </q-card-section>
          <q-card-section class="context-summary">
            <div class="context-summary__row">
              <span class="context-summary__label">Rol</span> <strong>{{ roleLabel }}</strong>
            </div>
            <div class="context-summary__row">
...
.chart-placeholder {
  background: linear-gradient(180deg, rgba(37, 99, 235, 0.03), rgba(255, 255, 255, 0)), #fff;
  border-radius: 18px;
  display: grid;
  gap: 20px;
  min-height: 220px;
