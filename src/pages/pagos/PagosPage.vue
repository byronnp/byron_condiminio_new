...
const search = ref('');
const statusFilter = ref<'Todos' | 'Pagado' | 'Pendiente' | 'Vencido'>('Todos');
...
const rows: PaymentRow[] = [
  ...
  },
  {
    id: 3,
    concept: 'Mora',
    detail: 'Torres del Verde - Diciembre',
    amount: '$48.50',
    status: 'Vencido',
    initials: 'MO',
  },
  ...
  {
    id: 5,
    concept: 'Reserva salon',
    detail: 'Condominio Aurora - Evento',
    amount: '$20.00',
    status: 'Pendiente',
    initials: 'RS',
  },
  {
    id: 6,
    concept: 'Multa',
    detail: 'Residencial Pacific - Acceso',
    amount: '$15.00',
    status: 'Vencido',
    initials: 'MU',
  },
  {
    id: 7,
    concept: 'Cuota ordinaria',
    detail: 'Torres del Verde - Febrero',
    amount: '$110.00',
    status: 'Pagado',
    initials: 'CO',
  },
  ...
  {
    id: 12,
    concept: 'Reserva piscina',
    detail: 'Marina Bay - Fin de semana',
    amount: '$18.00',
    status: 'Pendiente',
    initials: 'RP',
  },
...
const columns = [
  { name: 'item', label: 'Concepto', field: 'concept', align: 'left' as const },
  { name: 'amount', label: 'Monto', field: 'amount', align: 'right' as const },
...
const sortedRows = computed(() => {
  ...
  if (sortBy.value === 'name') return source.sort((a, b) => a.concept.localeCompare(b.concept));
...
function statusTone(status: PaymentRow['status']) {
  if (status === 'Pagado') return 'positive';
