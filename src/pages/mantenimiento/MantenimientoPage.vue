...
const rows: MaintenanceRow[] = [
  {
    id: 1,
    task: 'Revision bombas',
    detail: 'Condominio Aurora - Area tecnica',
    priority: 'Alta',
    status: 'Abierto',
    initials: 'RB',
  },
  ...
  {
    id: 3,
    task: 'Cambio luminarias',
    detail: 'Torres del Verde - Parqueo',
    priority: 'Alta',
    status: 'Cerrado',
    initials: 'CL',
  },
  {
    id: 4,
    task: 'Pintura general',
    detail: 'Marina Bay - Fachada',
    priority: 'Media',
    status: 'Abierto',
    initials: 'PG',
  },
  {
    id: 5,
    task: 'Revision ascensor',
    detail: 'Condominio Aurora - Torre 2',
    priority: 'Alta',
    status: 'En proceso',
    initials: 'RA',
  },
  {
    id: 6,
    task: 'Mantenimiento jardines',
    detail: 'Residencial Pacific - Areas verdes',
    priority: 'Media',
    status: 'Cerrado',
    initials: 'MJ',
  },
  {
    id: 7,
    task: 'Ajuste cerraduras',
    detail: 'Torres del Verde - Acceso principal',
    priority: 'Baja',
    status: 'Abierto',
    initials: 'AC',
  },
  {
    id: 8,
    task: 'Revision cisternas',
    detail: 'Marina Bay - Sotano',
    priority: 'Alta',
    status: 'En proceso',
    initials: 'RC',
  },
  {
    id: 9,
    task: 'Sellado filtraciones',
    detail: 'Condominio Aurora - Cubierta',
    priority: 'Alta',
    status: 'Cerrado',
    initials: 'SF',
  },
  {
    id: 10,
    task: 'Aire acondicionado',
    detail: 'Residencial Pacific - Salon comunal',
    priority: 'Media',
    status: 'Abierto',
    initials: 'AA',
  },
  {
    id: 11,
    task: 'Cableado red',
    detail: 'Torres del Verde - Oficina',
    priority: 'Media',
    status: 'Cerrado',
    initials: 'CR',
  },
  {
    id: 12,
    task: 'Lavado de areas',
    detail: 'Marina Bay - Lobby',
    priority: 'Baja',
    status: 'En proceso',
    initials: 'LA',
  },
...
const filteredRows = computed(() => {
  ...
  return rows.filter((row) => {
    ...
    const matchesQuery =
      !query || row.task.toLowerCase().includes(query) || row.detail.toLowerCase().includes(query);
