<template>
  <div class="page-shell">
    ...
    <section class="stats-grid"><slot name="stats" /></section>
    <q-card flat bordered class="table-card">
      ...
      <q-card-section class="table-wrap"> <slot name="table" /> </q-card-section>
      <q-card-section class="table-footer"> <slot name="footer" /> </q-card-section>
    </q-card>
  </div>
</template>
