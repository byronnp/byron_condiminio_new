  ...
  <q-layout view="lHh Lpr lFf" class="main-layout">
    ...
    >
      <div class="drawer-brand">
        <div class="drawer-brand__logo"><q-icon name="apartment" size="26px" /></div>
      ...
      <q-card v-if="!isDrawerMini" class="drawer-plan" flat>
        <q-card-section class="drawer-plan__header">
          <div class="drawer-plan__icon"><q-icon name="workspace_premium" size="18px" /></div>
    ...
    <q-header class="main-layout__header">
      <q-toolbar class="main-toolbar">
        ...
        <div class="toolbar-title">
          ...
          <div class="toolbar-title__subtitle">{{ pageSubtitle }}</div>
        </div>
        <q-space />
        <div class="toolbar-actions">
                ...
                <q-list class="toolbar-condo-menu__list">
                  ...
                  >
                    ...
                    <q-item-section>
                      ...
                      <q-item-label caption> {{ condominiumOptionMeta(condo) }} </q-item-label>
                    </q-item-section>
                    <q-item-section side>
                      <q-icon
          ...
          <q-chip v-else square class="toolbar-chip toolbar-chip--solid">
            <q-icon name="pin_drop" size="16px" class="q-mr-xs" /> {{ activeCondominiumName }}
          </q-chip>
...
function mapCondominiumOption(condominium: CondominiumOptionItem) {
  return { id: String(condominium.id), name: condominium.name, city: '', units: 0, active: true };
}
