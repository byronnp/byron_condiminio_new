export type NavigationItem = { label: string; icon?: string; to?: string; trailingIcon?: string };
...
export const defaultNavigationSections: NavigationSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Administradores', icon: 'admin_panel_settings', to: '/administradores' },
      { label: 'Roles', icon: 'assignment_ind', to: '/roles' },
